...
function VerifyOtp() {
  ...
  }, [contact, navigate, isAuthenticated]);
  ...
  const resendOtpHandler = async () => {
    try {
      ...
      const action = isUpdate
        ...
        : sendForgotPasswordOtp(phonenumber ? { phonenumber } : { email });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#02B833]/10 to-cyan-50 py-12">
            ...
            <CardHeader className="space-y-4 text-center">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <p className="text-sm font-semibold text-[#02B833]">{contact}</p>
                </div>
              ...
              <form onSubmit={handleSubmit(submitHandler)} className="space-y-6">
                ...
                {error && (
                  <Alert variant="destructive">
                    ...
                    <AlertDescription>{formatErrorMessage(error, "Invalid OTP")}</AlertDescription>
                  </Alert>
                )}
                ...
                <div className="space-y-3 pt-4 border-t">
                  {!canResend ? (
                    <div className="text-center">
                      <p className="text-sm text-gray-600">
                        Resend OTP in{" "}
                        <span className="font-semibold text-[#02B833]">{formatTime(timer)}</span>
                      </p>
                    </div>
                  ) : (
                    <Button
